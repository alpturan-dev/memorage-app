  ...
  return (
    <div className="flex flex-col min-h-screen">
      <main className="flex-1 py-2">
        <Link
          to="/exercises"
          className="py-4 flex items-center gap-2 text-xl font-semibold"
        >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <Dialog key={index}>
              ...
              <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    {t("exercisesPage.dialogSubtitle", {
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    >
                      <SelectTrigger className="w-full">
                        <SelectValue
                          placeholder={t("collectionsPage.selectLanguage")}
                        />
                      </SelectTrigger>
                      <SelectContent>
                    ...
                    onClick={() => {
                      if (selectedCollectionId) {
                        const collection = wordCollections.find(
                          (item) => item._id === selectedCollectionId
                        );
          ...
          <div className="relative opacity-60">
            <div
              className={
                "absolute top-2 right-1 text-xs z-50 font-bold bg-gradient-to-r from-[#016DCC] to-purple-600 bg-clip-text text-transparent rounded-sm px-0.5"
              }
            >
            ...
            <Card className="cursor-not-allowed">
              <CardHeader>
                <CardTitle className="text-xl">
                  {t("fillInTheBlanksExercise.name")}
                </CardTitle>
                <CardDescription className="text-xs">
                  {t("fillInTheBlanksExercise.description")}
                </CardDescription>
              </CardHeader>
              <CardContent className="flex items-center justify-center h-40">
                <div className="text-primary hover:text-primary-foreground">
                  ...
                  <span className="sr-only">
                    Start {t("fillInTheBlanksExercise.name")}
                  </span>
                </div>
              </CardContent>
            </Card>
