      ...
      <div className="block lg:hidden">
        <Tabs defaultValue="preset" className="pt-3">
          <TabsList className="grid w-full grid-cols-2">
            ...
            <TabsTrigger value="your" className="text-xs">
              {t("collectionsPage.your")}
            </TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="your">
            <div>
              <div className="flex flex-col pb-4">
                <Link
                  to="/collections"
                  className="pt-3 flex items-center gap-2 text-xl font-semibold"
                >
              ...
              <div className="grid gap-6">
                <div className="flex items-center justify-between">
                  <AddCollectionDialog
                    getAllWordCollections={getAllWordCollections}
                  />
                </div>
                <div className="grid gap-4 grid-cols-1">
                  {loading ? (
                    Array.from({ length: 7 }, (_, index) => (
                      <Skeleton
                        key={index}
                        className="h-[208px] w-full rounded-xl"
                      />
                    ))
                      ...
                      <Card key={item._id}>
                        <CardHeader>
                          ...
                          <CardDescription className="text-xs">
                            {t("collectionsPage.cardSubtitle")}{" "}
                        ...
                        <CardFooter className="justify-between gap-1">
                          ...
                          <div>
                            <ExerciseDialog
                              selectedCollectionId={item._id}
                              languageCode={item?.targetLanguage?.code}
                              preset={false}
                            />
                          </div>
                          <AlertDialog>
                    ...
                    <div className="w-full max-w-md mx-auto border-0">
                      <CardContent className="pt-6 pb-4 text-center">
                        ...
                        <h3 className="text-lg font-semibold mb-2">
                          {t("collectionsPage.noCollectionTitle")}
                        </h3>
        ...
        <main className="grid grid-cols-1 lg:grid-cols-7 py-2">
          ...
          <div className="lg:col-span-2">
            <div className="flex flex-col pb-4">
              <Link
                to="/collections"
                className="pt-6 flex items-center gap-2 text-xl font-semibold"
              >
                <span>{t("collectionsPage.yourCollectionsTitle")}</span>
              </Link>
              <CardDescription className="text-xs py-0 pt-[6px]">
